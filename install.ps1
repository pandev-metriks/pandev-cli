...
.DESCRIPTION
    ...
    Tokens replaced by the publish step (do NOT pre-fill them here):
      ...
      v2.5.16                   - release tag hosting the assets, e.g. v2.5.0-beta
      951a7ec6daa744415ffd4e7a1ab82067efea7ecc202b80f83120726fc579e5fd  - checksum of the Windows .zip asset
...
& {
    ...
    $VERSION = '2.5.16'
    $TAG = 'v2.5.16'
    $WINDOWS_AMD64_SHA256 = '951a7ec6daa744415ffd4e7a1ab82067efea7ecc202b80f83120726fc579e5fd'
    ...
    # '951a7ec6daa744415ffd4e7a1ab82067efea7ecc202b80f83120726fc579e5fd', but the publish step's str.replace runs
