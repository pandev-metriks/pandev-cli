...
.DESCRIPTION
    ...
    Tokens replaced by the publish step (do NOT pre-fill them here):
      ...
      v2.4.13                   - release tag hosting the assets, e.g. v2.5.0-beta
      0c0c175ff9cd91c89511174192891316c2a607c1d698e643578f1254d5487f8e  - checksum of the Windows .zip asset
...
& {
    ...
    $VERSION = '2.4.13'
    $TAG = 'v2.4.13'
    $WINDOWS_AMD64_SHA256 = '0c0c175ff9cd91c89511174192891316c2a607c1d698e643578f1254d5487f8e'
    ...
    Write-Host "  PanDev CLI Plugin - Stable install (Windows)" -ForegroundColor Cyan
    Write-Host "==========================================================" -ForegroundColor Cyan
    ...
    # '0c0c175ff9cd91c89511174192891316c2a607c1d698e643578f1254d5487f8e', but the publish step's str.replace runs
